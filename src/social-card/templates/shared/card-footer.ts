...
const cardFooter = (langs: string, repos: string, reactions?: number) => `
  ...
  reactions
    ...
    : ""
            ...
            <div>
               <img tw="w-46px h-46px rounded" src="https://raw.githubusercontent.com/khulnasoft-opensource/assets/d9a0d5a317036084aa3f5f4e20cdfbe58dc37377/svgs/slice-Orange-Gradient.svg"/>
            </div>
          </div>
